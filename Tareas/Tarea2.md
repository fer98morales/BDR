...
Debido al numero de variables en mis bases opte por hacer el diagrama en distintos niveles
...
Entidad1 --- E1_Atributo12([attributes]) --- E1_D12{{LISTA}}
Entidad1 --- E1_Atributo13([categories]) --- E1_D13{{"TEXTO (100)"}}
Entidad1 --- E1_Atributo14([hours]) --- E1_D14{{LISTA}}
```
...
flowchart LR
    ...
    Entidad5 --- E5_Atributo3([review_count]) --- E5_D3{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo4([yelping_since]) --- E5_D4{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo5([useful]) --- E5_D5{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo6([funny]) --- E5_D6{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo7([cool]) --- E5_D7{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo8([elite]) --- E5_D8{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo9([friends]) --- E5_D9{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo10([fans]) --- E5_D10{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo11([average_stars]) --- E5_D11{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo12([compliment_hot]) --- E5_D12{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo13([compliment_more]) --- E5_D13{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo14([compliment_profile]) --- E5_D14{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo15([compliment_cute]) --- E5_D15{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo16([compliment_list]) --- E5_D16{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo17([compliment_note]) --- E5_D17{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo18([compliment_plain]) --- E5_D18{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo19([compliment_cool]) --- E5_D19{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo20([compliment_funny]) --- E5_D20{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo21([compliment_writer]) --- E5_D21{{"TEXTO (100)"}}
    Entidad5 --- E5_Atributo22([compliment_photos]) --- E5_D22{{"TEXTO (100)"}}
```